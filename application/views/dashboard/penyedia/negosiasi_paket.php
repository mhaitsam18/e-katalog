              ...
              <div class="row">
                  ...
                  <br>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>Catatan</td>
                                <td><textarea name="catatan" class="form-control" id="" cols="30" rows="10" placeholder="Catatan Penyedia (Wajib Diisi)"></textarea></td>
                            </tr>
                            <tr>
                                <th colspan="2">Negosiasi Spesifikasi</th>
                            </tr>
                            ...
                            <tr>
                                <td>Catatan</td>
                                <td> <textarea name="catatan2" class="form-control" id="" cols="30" rows="10" placeholder="Catatan Penyedia (Wajib Diisi)"></textarea></td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row">
                  <div class="col-md-8">
                      <p>Apakah Anda yakin untuk menyetujui negosiasi ini?</p>
                  </div>
              </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              <a href="<?=base_url()?>Penyedia/persetujuan_paket/<?=$nego_harga->id_paket?>" class="btn btn-danger">Iya</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
