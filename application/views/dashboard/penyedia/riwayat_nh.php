  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
          <a href="<?=base_url()?>Penyedia/detail_nego/<?=$id?>" class="btn btn-danger">
            ...
            <div class="card" style="background-color:#FFC107">
              <div class="card-header">
                <h3 class="card-title"><b style="color:white">Detail Riwayat Negosiasi Harga <?=$nego->nama_paket?></b></h3>
              </div>
              <!-- /.card-header -->
                               ...
                               <td>
                                  <?php 
                                    if(!$data->catatan_penyedia){?>
                                      -
                                    <?php }else{?>
                                      <?php echo $data->catatan_penyedia?>
                                    <?php } ?>
                               </td>
                               <td>
                                  <?php 
                                    if(!$data->catatan_pembeli){?>
                                      -
                                    <?php }else{?>
                                      <?php echo $data->catatan_pembeli?>
                                    <?php } ?>
                               </td>
                            </tr>
                            <?php }?>
