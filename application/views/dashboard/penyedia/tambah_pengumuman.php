        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open_multipart('Penyedia/inputPengumuman', array('method' => 'POST',)); ?>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a href="<?=base_url()?>Penyedia/pengumuman" class="btn btn-danger">Kembali</a>
                  <input type="submit" value="Submit" class="btn btn-info">
                  <a style="color:white" href="<?=base_url()?>Penyedia/tambah_merek/1" class="btn btn-warning tampilkan">
                  <i class="fa fa-plus" aria-hidden="true"></i>
                  Merek
                  </a>
                  <a href="<?=base_url()?>Penyedia/tambah_tahapan/1" class="btn btn-success tampilkan">
                  <i class="fa fa-plus" aria-hidden="true"></i>
                  Tahapan Pengumuman
                  </a>
                </div>
