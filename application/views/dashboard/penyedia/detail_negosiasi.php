  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              <?php if($nego->status == 2 || $nego->status == 4){ ?>
                <a href="<?=base_url()?>Penyedia/kelola_negosiasi" class="btn btn-danger">
                <i class="fas fa-arrow-alt-circle-left"></i>
                Kembali
                </a>
              <?php }else{?>
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#back<?=$nego->id_paket?>">
                  <i class="fas fa-arrow-alt-circle-left"></i>
                  Kembali
                  </button>
              <?php } ?>
              <br><br>
							<div class="card" style="background-color:maroon">
								<div class="card-header">
									...
									<?php }else{?>
										<h3 class="card-title"><b style="color:white">Detail Negosiasi <?=$nego->nama_paket?> 
									<?php }?>
											<?php 
											if(!$nego->no_pr){
                          ...
                          ?>
                                ...
                                if($nego->status == 0){?>
                                    ...
                                    ?>
											...
											<div class="col-md-12">
                    <br>
                      <a href="<?=base_url()?>Penyedia/riwayat_negosiasi_harga/<?=$nego->id_paket?>" class="btn btn-warning" style="color:white">
                      <i class="fas fa-money-bill"></i>
                          &nbsp;&nbsp;Riwayat Negosiasi Harga
                      </a>
                      <a href="<?=base_url()?>Penyedia/riwayat_negosiasi_spesifikasi/<?=$nego->id_paket?>" class="btn btn-primary" style="color:white">
            ...
            <div class="modal-body">
              <div class="row">
                  <div class="col-md-12">
                      ...
                      <a href="<?=base_url()?>Penyedia/negosiasi_harga/<?=$nego->id_paket?>" class="btn btn-primary">
                          <i class="fas fa-money-bill"></i>
                          Negosiasi Harga Saja 
                      </a>
                      <a href="<?=base_url()?>Penyedia/negosiasi_teknis/<?=$nego->id_paket?>" class="btn btn-danger">
                        <i class="fas fa-server"></i>
                        Negosiasi Teknis Saja   
                      </a>
                      <a href="<?=base_url()?>Penyedia/negosiasi_tanggal/<?=$nego->id_paket?>" class="btn btn-warning">
      ...
      <div class="modal fade" id="back<?=$nego->id_paket?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
              <a href="<?=base_url()?>Penyedia/kelola_negosiasi" class="btn btn-danger">Setuju Ke Kelola Negosiasi</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
