          ...
          <div class="col-12">
            <div class="card" style="background-color:blue">
              <div class="card-header">
                <h3 class="card-title"><b style="color:white">Data Lampiran Produk <?=$detail_produk->nama_produk?></b></h3>
              </div>
              <!-- /.card-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a style="color:white" target="__blank" href="<?=base_url()?>uploads/file_lampiran/<?=$data->keterangan?>" class="btn btn-warning">
                                    <i class="fas fa-file"></i>
                                    Lampiran
                                </a>
                                </td>
                                <td> 
                                    <a href="<?=base_url()?>Penyedia/hapus_lampiran/<?=$data->id_lampiran?>" class="btn btn-danger">
