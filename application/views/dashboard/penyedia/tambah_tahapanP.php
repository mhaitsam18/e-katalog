        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open_multipart('Penyedia/inputTahapan', array('method' => 'POST',)); ?>
              <div class="card-body">
                  <div class="form-g">
                  ...
                  <br>
                    <table width="100%" cellpadding="8">
                        ...
                        <tr>
                            ...
                            <td><textarea name="perubahan1" class="form-control" placeholder="Perubahan" id="" cols="50" rows="2"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="perubahan2" class="form-control" placeholder="Perubahan" id="" cols="50" rows="2"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="perubahan3" class="form-control" placeholder="Perubahan" id="" cols="50" rows="2"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="perubahan4" class="form-control" placeholder="Perubahan" id="" cols="50" rows="2"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="perubahan5" class="form-control" placeholder="Perubahan" id="" cols="50" rows="2"></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="perubahan6" class="form-control" placeholder="Perubahan" id="" cols="50" rows="2"></textarea></td>
                        </tr>
                        <tr>
                    </table>
                  </div>
