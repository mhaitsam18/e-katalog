        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Kelola Selesai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Paket Selesai</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body"> 
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        Menunggu Konfirmasi Paket Terkirim</a>
                      ...
                      <td>
                          <center>
                          <a href="<?=base_url()?>Penyedia/print_invoice/<?=$d->id_paket?>" target="_blank" class="btn btn-primary btn-inline-blok btn-sm" rel="noopener noreferer">
                            <i class="fas fa-file"></i>
                            Invoice
                          </a><br>
													<?php 
													if(!$d->receipt){?>
													<span><i style="color:red">belum ada no.receipt</i></span>
													<?php }else{?>
														<i>No.Receipt</i> <?=$d->receipt?>
													<?php }?>
                          </center>
                      </td>
                      <td>
                        <center>
                        <a href="<?=base_url()?>Penyedia/detail_kirim/<?=$d->id_paket?>" class="btn btn-primary">
