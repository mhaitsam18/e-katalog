<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Penyedia</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url()?>Penyedia" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url()?>Penyedia/kategori_etalase" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url()?>Penyedia/etalase_produk" class="nav-link">
              <i class="nav-icon fas fa-shopping-bag"></i>
              <p>
                Kelola Etalase Produk
              </p>
            </a>
          </li>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url()?>Penyedia/kelola_negosiasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Negosiasi Paket</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>Penyedia/kelola_kirim" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Paket Harus Diproses</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url()?>Penyedia/kelola_selesai" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Paket Dikirim/Selesai</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a href="<?=base_url()?>Penyedia/pengumuman" class="nav-link">
