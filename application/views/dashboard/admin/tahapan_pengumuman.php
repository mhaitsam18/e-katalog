...
<head>
	...
	<title>Tahapan Pengumuman | E-Katalog</title>
						...
						<div class="col-12">
							<div class="card" style="background-color:blue">
								<div class="card-header">
									<h3 class="card-title"><b style="color:white">Jadwal <?= $pengumuman->judul ?></b></h3>
								</div>
								<!-- /.card-header -->
													...
													<tbody>
														...
														foreach ($tahapan as $data) { ?>
															<tr>
																...
																<td><?= $data->judul ?></td>
																<td><?php
																		if ($data->tanggal_mulai == "0000-00-00") {
																			echo "-";
																		} else {
																			echo $data->tanggal_mulai;
																		} ?>
																</td>
																<td>
																	<?php
																	if ($data->tanggal_akhir == "0000-00-00") {
																		echo "-";
																	} else {
																		echo $data->tanggal_akhir;
																	} ?>
																</td>
																<td><?= $data->perubahan ?></td>
																<td>
																	<a href="<?= base_url() ?>Admin/hapus_tahapan/<?= $data->id_tp ?>" class="btn btn-danger">
