...
<head>
	...
	<title>Edit Berita | E-Katalog</title>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card">
								<!-- form start -->
								<?= form_open_multipart('Admin/update_berita/' . $berita->id_berita, array('method' => 'POST')); ?>
								<div class="card-body">
									<div class="form-group">
										<label for="judul">Judul Berita</label>
										<input type="text" name="judul" class="form-control <?= form_error('judul') ? 'is-invalid' : ''; ?>" placeholder="Judul" id="judul" value="<?= $berita->judul; ?>">
									...
									<div class="form-group">
										...
										<select name="kategori" id="kategori" class="form-control">
											...
											<?php foreach ($kategori as $data) { ?>
												<option value="<?= $data->id_kb ?>" <?= $data->id_kb === $berita->id_kb ? "selected" : "" ?>>
													<?= $data->nama_kb ?>
												</option>
											<?php } ?>
										</select>
									...
									<div class="d-flex flex-column">
										<label for="sampul_preview">Gambar Preview</label>
										<div class="mb-3">
											<img src="<?= base_url('uploads/poster_berita/') . $berita->gambar ?>" class="img-thumbnail img-preview" width="300">
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="custom-file col-sm-6">
													<input type="hidden" value="<?= $berita->gambar; ?>" name="old_gambarberita">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="body" placeholder="Isi deskripsi.." id="summernote" rows="10">
<?= $berita->body; ?>
                    </textarea>
								...
								<div class="card-footer">
									...
									<a style="color:white" href="<?= base_url() ?>admin/edit_tag/<?= $berita->id_berita; ?>" class="btn btn-warning tampilkan">
