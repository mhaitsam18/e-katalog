      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php if($nego->status == 1){ ?>
            ...
            <?php }else{?>
              <a href="<?=base_url()?>PP/detail_paket_negosiasi/<?=$nego->id_paket?>" class="btn btn-danger">
                    <i class="fas fa-arrow-alt-circle-left"></i>
                    Kembali
              </a>
            <?php } ?>
            ...
            <div class="card" style="background-color:maroon">
              <div class="card-header">
                <h3 class="card-title"><b style="color:white">Negosiasi Paket <?=$nego->no_pr?></b></h3>
              </div>
              <!-- /.card-header -->
              ...
              <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <br>
                    <?php echo form_open_multipart('PP/input_ns', array('method' => 'POST',)); ?>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <tbody>
                                ...
                                <td>
                                    <textarea class="form-control" disabled cols="30" rows="6"><?=$nego_spesifikasi->catatan_penyedia?></textarea>
                                </td>
                            </tr>
														<?php }?>
                            <tr>
                                ...
                                <td>
                                    <textarea name="spesifikasi" id="summernote" cols="30" rows="6"></textarea>
                                </td>
                            </tr>
                            <tr>
                              <td></td>
