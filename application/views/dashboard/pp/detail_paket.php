...
<body class="hold-transition sidebar-mini">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<a href="<?=base_url()?>PP/kelola_paket" class="btn btn-danger">
								<i class="fas fa-arrow-alt-circle-left"></i>
								Kembali
							</a>
							<?php }else if($nego->status == 3){ ?>
							<a href="<?=base_url()?>PP/kelola_negosiasi" class="btn btn-danger">
								<i class="fas fa-arrow-alt-circle-left"></i>
								Kembali
							</a>
							<?php }else if($nego->status == 5 || $nego->status == 6 || $nego->status == 7){?>
							<a href="<?=base_url()?>PP/kelola_selesai" class="btn btn-danger">
								<i class="fas fa-arrow-alt-circle-left"></i>
								Kembali
							</a>
							<?php }else if($nego->status == 8){?>
							<a href="<?=base_url()?>PP/kelola_penolakan" class="btn btn-danger">
								<i class="fas fa-arrow-alt-circle-left"></i>
								Kembali
							</a>
							<?php }else{?>
							<button type="button" class="btn btn-danger" data-toggle="modal"
								data-target="#back<?=$nego->id_paket?>">
								<i class="fas fa-arrow-alt-circle-left"></i>
								Kembali
							</button>
							<?php } ?>
							...
							<div class="card" style="background-color:maroon">
								<div class="card-header">
									<?php if($file_status == 1){?>
									<h3 class="card-title"><b style="color:white">Detail <?=$nego->nama_paket?>
											<?php }else{?>
											<h3 class="card-title"><b style="color:white">Detail Negosiasi
													<?=$nego->nama_paket?>
													<?php }?>
													<?php 
											if(!$nego->no_pr){
														...
														<tr>
															...
															<td>
																...
																<button class="btn btn-danger" style="font-size:10px"
																	data-toggle="modal"
																	data-target="#bandingkan<?=$data->id_produk?>">Bandingkan</button>
																	<?php }?>
																<hr>
																<b>Spesifikasi</b><br>
																Merek :
                          ...
                          ?>
                                ...
                                if($nego->status == 0){?>
													...
													<tr>
														<td colspan="2">
															<center><a target="_blank" rel="noopener noreferer"
																	href="<?=base_url()?>LandingPage/kak/<?=$nego->link?>">Klik
																	Untuk Melihat Lihat KAK</a></center>
														</td>
													</tr>
													<?php }else{?>
														<tr>
														<td colspan="2">
															<center><a target="_blank" rel="noopener noreferer"
																	href="<?=base_url()?>uploads/dokumen/<?=$nego->dokumen?>">Klik
																	Untuk Melihat Dokumen</a></center>
														</td>
													</tr>
													<?php }?>
                                    ...
                                    if($nego->status == 0){?>
														...
														<tr>
															<td>Tanggal Pengiriman
																...
																<span style="font-size:10px;color:red">(Pengajuan dari
																	Penyedia)</span>
																<?php }else{?>
																<span style="font-size:10px;color:red">(Pengajuan dari
																	PP)</span>
                                    ...
                                    ?>
												...
												<br>
												<br>
												<?php if($nego->status == 1 || $nego->status == 3){?>
												<button type="button" class="btn btn-warning" data-toggle="modal"
													data-target="#nego<?=$nego->id_paket?>">
													<i class="fas fa-pencil-alt"></i>
													Ajukan Negosiasi
												</button>
												<button type="button" class="btn btn-primary" data-toggle="modal"
													data-target="#setuju<?=$nego->id_paket?>">
													<i class="fas fa-check-circle"></i>
													Setuju
												</button>
												<button type="button" class="btn btn-danger" data-toggle="modal"
													data-target="#tolak<?=$nego->id_paket?>">
													<i class="fas fa-times-circle"></i>
													Tolak Paket
												</button>
												<?php }else if($nego->status == 2) {?>
												<button type="button" class="btn btn-warning" data-toggle="modal"
													data-target="#nego<?=$nego->id_paket?>">
													<i class="fas fa-pencil-alt"></i>
													Ajukan Negosiasi
											...
											<div class="col-md-12">
												<br>
												<a href="<?=base_url()?>PP/riwayat_paket/<?=$nego->id_paket?>"
													class="btn btn-success">
													<i class="fas fa-file"></i>
													&nbsp;&nbsp;Riwayat Paket
												</a>
												<a href="<?=base_url()?>PP/riwayat_negosiasi_harga/<?=$nego->id_paket?>"
													class="btn btn-warning" style="color:white">
													<i class="fas fa-money-bill"></i>
													&nbsp;&nbsp;Riwayat Negosiasi Harga
												</a>
												<a href="<?=base_url()?>PP/riwayat_negosiasi_spesifikasi/<?=$nego->id_paket?>"
	...
	<div class="modal active" id="bandingkan<?=$data->id_produk?>">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Bandingkan Produk</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<?php
				$hasil = $this->Model_pp->get_compare($data->no_item,$data->harga,$data->id_produk); ?>
				<?php if(!$hasil){?>
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12">
							<center><b>Mohon maaf, tidak ada produk serupa</b></center>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-3">
							<table cellpadding="5px">
								<tr>
									<td><b style="color:red">Produk Saat Ini</b></td>
								</tr>
								<tr>
									<td>
										<?php if(!$data->foto){?>
										<img src="<?=base_url()?>assets/landingpage/img/dummyproduct.png"
											alt="Foto Produk" width="150px">
										<?php }else{?>
										<img src="<?=base_url()?>uploads/foto_produk/<?=$data->foto?>" alt="Foto Produk"
											width="150px">
										<?php }?>
									</td>
								</tr>
								<tr>
									<td><b><?=$data->nama_produk?></b>
										<br><?=$data->no_item?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td><a href="<?=base_url()?>LandingPage/lihat_produk/<?=$data->id_produk?>"
											target="__blank">Lihat Spesifikasi Lainnya</a></td>
								</tr>
							</table>
						</div>
						<?php
						foreach($hasil as $compare){?>
						<div class="col-md-3">
							<table cellpadding="5px">
								<tr>
									<td><b style="color:red">Produk Sejenis</b></td>
								</tr>
								<tr>
									<td>
										<?php if(!$compare->foto){?>
										<img src="<?=base_url()?>assets/landingpage/img/dummyproduct.png"
											alt="Foto Produk" width="150px">
										<?php }else{?>
										<img src="<?=base_url()?>uploads/foto_produk/<?=$compare->foto?>"
											alt="Foto Produk" width="150px">
										<?php }?>
									</td>
								</tr>
								<tr>
									<td><b><?=$compare->nama_produk?></b>
										<br><?=$compare->no_item?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td style="height:170px">
										...
										<?=$compare->merek?> <br>
										<b>Masa Berlaku :</b>
										<?=$compare->masa_berlaku?> <br>
										<b>No Produk Penyedia :</b>
										<?=$compare->no_produk_penyedia?> <br>
										<b>Deskripsi :</b>
										<?=$compare->deskripsi?> <br>
									</td>
								</tr>
								<tr>
									<td><a href="<?=base_url()?>LandingPage/lihat_produk/<?=$compare->id_produk?>"
											target="__blank">Lihat Spesifikasi Lainnya</a></td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td>
										<button type="button" class="btn btn-danger" data-toggle="modal"
											data-target="#switch<?=$compare->id_produk?><?=$data->id_produk?>">
	...
	foreach($hasil as $p){
		foreach($produk as $data){ ?>
	<div class="modal fade" id="switch<?=$p->id_produk?><?=$data->id_produk?>">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<p>Apakah Anda yakin untuk <b>mengubah</b> produk tersebut?</p>
							<table class="table" width="100%">
								<tr>
									<th>Produk Sebelum</th>
									<th style="color:red">Produk Baru</th>
								</tr>
								<tr>
								...
								<td>
									...
									<td>
										...
										<img src="<?=base_url()?>assets/landingpage/img/dummyproduct.png"
											alt="Foto Produk" width="150px">
										<?php }else{?>
										<img src="<?=base_url()?>uploads/foto_produk/<?=$p->foto?>" alt="Foto Produk"
											width="150px">
										<?php }?>
									</td>
								</tr>
				...
				<div class="modal-footer justify-content-between">
					<button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
					<a href="<?=base_url()?>PP/switch_product/<?=$p->id_produk?>/<?=$nego->id_keranjang?>"
						class="btn btn-danger">Setuju
					</a>
				</div>
			</div>
			<!-- /.modal-content -->
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							...
							<a href="<?=base_url()?>PP/negosiasi_teknis/<?=$nego->id_paket?>" class="btn btn-danger">
								<i class="fas fa-server"></i>
								Negosiasi Teknis Saja
							</a>
	...
	<div class="modal fade" id="back<?=$nego->id_paket?>">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Apakah Anda yakin sudah menyetujui <b>negosiasi harga, spesifikasi, dan tanggal</b> pada paket
						ini?</p>
				</div>
				<div class="modal-footer justify-content-between">
					<button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
