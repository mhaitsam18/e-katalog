                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table class="table">
                                                    <thead>
                                                        <th colspan="3">Tanggal yang tertera di PO</th>
                                                    </thead>
                                                    <tr>
                                                        <th>Tanggal Mulai</th>
                                                        <th>Tanggal Akhir</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Catatan 
																													<?php if($nego_tanggal->catatan_pembeli == NULL){?>
																														<span style="color:red">Penyedia</span>
																													<?php }else{?>	
																														<span style="color:red">Pembeli</span>
																													<?php }?>
																												</th>
                                                    </tr>
                                                    <tbody>
                                                ...
                                                <br>
                                                <?php echo form_open_multipart('PP/input_nt', array('method' => 'POST',)); ?>
