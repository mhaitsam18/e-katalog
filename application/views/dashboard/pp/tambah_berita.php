        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open_multipart('PPK/inputBerita', array('method' => 'POST',)); ?>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a href="<?=base_url()?>PPK/berita" class="btn btn-danger">Kembali</a>
                  <input type="submit" value="Submit" class="btn btn-info">
                  <a style="color:white" href="<?=base_url()?>PPK/tambah_tags/1" class="btn btn-warning tampilkan">
