                            ...
                            foreach($produk as $data){?>
														<tr>
															...
															<td>
																...
																<button class="btn btn-danger" style="font-size:10px" data-toggle="modal" data-target="#bandingkan<?=$data->id_produk?>">Bandingkan</button>
																<hr>
																<b>Spesifikasi</b><br>
																Merek :
																<?=$data->merek?> <br>
                                ...
                                if($nego->status == 0){?>
													...
													<tr>
														<td colspan="2">
															<center><a target="_blank" rel="noopener noreferer"
																	href="<?=base_url()?>po/<?=$nego->id_kak?>">Klik
                                    ...
                                    if($nego->status == 0){?>
														...
														<tr>
															<th colspan="2">
																<center>
																	<p style="margin-bottom:2px"> Harga, Spesifikasi,
																		dan Tanggal</p>
																</center>
															</th>
														</tr>
														...
														<tr>
															...
															<td>
																...
																<?php }else{?>
																<b> Penyedia :</b>
																<?=$nego_spesifikasi->catatan_penyedia?> <br>
																<b>Pembeli &nbsp; :</b>
																<?php echo $nego_spesifikasi->catatan_pembeli?>
																<?php }?>
															</td>
														</tr>
														<tr>
	...
	<div class="modal active" id="bandingkan<?=$data->id_produk?>">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<?php
				$hasil = $this->Model_pp->get_compare($data->no_item,$data->harga); ?>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-3">
								<table cellpadding="5px">
									...
									<tr>
										<td><b style="color:red">Rp <?php echo number_format($data->harga,2,".",",");?></b></td>
									</tr>
									<tr>
										<td>
											<b>Merek :</b>
						...
						<div class="col-md-3">
								<table cellpadding="5px">
									...
									<tr>
										<td><b style="color:red">Rp <?php echo number_format($compare->harga,2,".",",");?></b></td>
									</tr>
									<tr>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							...
							<a href="<?=base_url()?>PP/negosiasi_spesifikasi/<?=$nego->id_paket?>"
	...
	<div class="modal fade" id="back<?=$nego->id_paket?>">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer justify-content-between">
					<button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
					<a href="<?=base_url()?>PP/kelola_paket" class="btn btn-danger">Setuju</a>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
