...
<html lang="id">
  ...
  <title>Riwayat Negosiasi Harga</title>
          ...
          <a href="<?=base_url()?>PP/detail_paket_negosiasi/<?=$id?>" class="btn btn-danger">
            ...
            <div class="card" style="background-color:#FFC107">
              <div class="card-header">
                <h3 class="card-title"><b style="color:white">Detail Riwayat Negosiasi Harga Paket</b></h3>
              </div>
              <!-- /.card-header -->
              ...
              <div class="row">
                  <div class="col-md-12">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
													<tr>
														<td colspan="7"><span style="color:red;"><center>↓↓ Update Status Paket Terbaru ↓↓</center></span></td>
													</tr>
                            <?php 
                            $no = 1;
                            ...
                            <tr>
                               ...
                               <td>Rp <?php echo number_format($data->ongkir,2,".",",");?></td>
                               <td>
                               ...
                               <!-- <td>
                               <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg<?=$data->id_paket?>">
