        ...
        <div class="row">
          <div class="col-12">
             <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="<?=base_url()?>PPK/tambah_berita/0" class="btn btn-success">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a href="<?=base_url()?>PPK/tag_berita/<?=$data->id_berita?>" class="btn btn-warning">
                            <i class="fas fa-info-circle"></i>  
                        Tags</a>
                      </td>
                      <td>
                        <a href="<?=base_url()?>PPK/hapus_berita/<?=$data->id_berita?>" class="btn btn-danger">
