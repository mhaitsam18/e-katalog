        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                  <a href="<?=base_url()?>PPK/tambah_pengumuman/0" class="btn btn-success">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-primary" href="<?=base_url()?>PPK/merek_pengumuman/<?=$data->id_pengumuman?>">
                      ...
                      <td>
                        ...
                        <a class="btn btn-success" target="_blank" href="<?=base_url()?>uploads/dokumen_pengumuman/<?=$data->dok_pengumuman?>" rel="noopener noreferer">
                      ...
                      <td>
                      <a href="<?=base_url()?>PPK/tahapan_pengumuman/<?=$data->id_pengumuman?>" class="btn btn-warning">
                            <i class="fas fa-info-circle"></i>
                        Info</a>
                      </td>
                      <td>
                        <a href="<?=base_url()?>PPK/hapus_pengumuman/<?=$data->id_pengumuman?>" class="btn btn-danger">
