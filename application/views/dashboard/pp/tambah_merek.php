        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open_multipart('PPK/inputMerek', array('method' => 'POST',)); ?>
              <div class="card-body">
                  <div class="form-g">
                  ...
                  <br>
                    <table width="80%" cellpadding="8">
                        ...
                        <tr>
                            ...
                            <td><textarea name="deskripsi1" class="form-control" placeholder="Deskripsi" id="" cols="30" rows="5"></textarea></td>
                        </tr>
                        <tr>
                        <td>
                            ...
                            <td><textarea name="deskripsi2" class="form-control" placeholder="Deskripsi" id="" cols="30" rows="5"></textarea></td>
                        </tr>
                        <tr>
                            <td>
                                <select name="kategori3" class="form-control">
                                    <option value="">-- Pilih Etalase --</option>
                                    <?php foreach($kategori as $data){?>
                                    <option value="<?=$data->id_etalase?>"><?=$data->nama_etalase?></option>
                                    <?php }?>
                            ...
                            <td><textarea name="deskripsi3" class="form-control" placeholder="Deskripsi" id="" cols="30" rows="5"></textarea></td>
                        </tr>
                        <tr>
                            <td>
                                <select name="kategori4" class="form-control">
                                    <option value="">-- Pilih Etalase --</option>
                                    <?php foreach($kategori as $data){?>
                                    <option value="<?=$data->id_etalase?>"><?=$data->nama_etalase?></option>
                                    <?php }?>
                            ...
                            <td><textarea name="deskripsi4" class="form-control" placeholder="Deskripsi" id="" cols="30" rows="5"></textarea></td>
                        </tr>
                        <tr>
                        <td>
                                <select name="kategori5" class="form-control">
                                    <option value="">-- Pilih Etalase --</option>
                                    <?php foreach($kategori as $data){?>
                                    <option value="<?=$data->id_etalase?>"><?=$data->nama_etalase?></option>
                                    <?php }?>
                            ...
                            <td><textarea name="deskripsi5" class="form-control" placeholder="Deskripsi" id="" cols="30" rows="5"></textarea></td>
                        </tr>
                        <tr>
                            <td>
                                <select name="kategori6" class="form-control">
                                    <option value="">-- Pilih Etalase --</option>
                                    <?php foreach($kategori as $data){?>
                                    <option value="<?=$data->id_etalase?>"><?=$data->nama_etalase?></option>
                                    <?php }?>
                            ...
                            <td><textarea name="deskripsi6" class="form-control" placeholder="Deskripsi" id="" cols="30" rows="5"></textarea></td>
                        </tr>
                    </table>
                  </div>
                </div>
